...
class _LoginPageState extends State<LoginPage> {
  ...
  // Initialize login state checker
  checkLoginStatus() async {
    final appStatus = await SharedPreferences.getInstance();
    username = appStatus.getString('username') ?? false;
    password = appStatus.getString('password') ?? false;
    age = appStatus.getString('age') ?? false;
